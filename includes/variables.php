    ...
    $tsml_programs = [
        'aca' => [
            ...
            'types' => [
                ...
                'POC' => __('BIPOC', '12-step-meeting-list'),
                'CAP' => __('Captions', '12-step-meeting-list'),
                'CC' => __('Child Care Available', '12-step-meeting-list'),
                'C' => __('Closed', '12-step-meeting-list'),
                'COS' => __('Concepts of Service', '12-step-meeting-list'),
                ...
                'LLW' => __('Laundry Lists Workbook', '12-step-meeting-list'),
                'LGBTQ' => __('LGBTQ+', '12-step-meeting-list'),
                'LPG' => __('Loving Parent Guidebook', '12-step-meeting-list'),
                'M' => __('Men', '12-step-meeting-list'),
                'NS' => __('Needs Support', '12-step-meeting-list'),
                ...
                'TEEN' => __('Teen (Ages 12 to 18)', '12-step-meeting-list'),
                'TR' => __('Traditions', '12-step-meeting-list'),
        ...
        'aa' => [
            ...
            'types' => [
                ...
                'BI' => __('Bisexual', '12-step-meeting-list'),
        ...
        'slaa' => [
            ...
            'types' => [
                '12x12' => __('Framework for Living (12x12x12)', '12-step-meeting-list'),
                'ALLG' => __('All Genders Welcome', '12-step-meeting-list'),
                'AN' => __('Anorexia Focus', '12-step-meeting-list'),
                'ASOG' => __('State of Grace', '12-step-meeting-list'),
                'POA' => __('Attendance Voucher', '12-step-meeting-list'),
                'BDSM' => __('BDSM Focus', '12-step-meeting-list'),
                'B' => __('Book Study', '12-step-meeting-list'),
                'CAM' => __('Camera On', '12-step-meeting-list'),
                'BA' => __('Child Care Available', '12-step-meeting-list'),
                'H' => __('Chips', '12-step-meeting-list'),
                'C' => __('Closed', '12-step-meeting-list'),
                'XT' => __('Cross Talk Permitted', '12-step-meeting-list'),
                'FTSY' => __('Fantasy', '12-step-meeting-list'),
                'GC' => __('Getting Current', '12-step-meeting-list'),
                'X' => __('Handicapped Accessible', '12-step-meeting-list'),
                'HOW' => __('H.O.W. Meeting', '12-step-meeting-list'),
                'HR' => __('Healthy Relationships', '12-step-meeting-list'),
                'LEG' => __('Legal Consequences', '12-step-meeting-list'),
                'LGBTQ' => __('LGBTQ+', '12-step-meeting-list'),
                'LIT' => __('Literature Reading', '12-step-meeting-list'),
                'MED' => __('Meditation', '12-step-meeting-list'),
                'M' => __('Men', '12-step-meeting-list'),
                'MULT' => __('Multiple Addictions', '12-step-meeting-list'),
                'NEUR' => __('Neurodivergent', '12-step-meeting-list'),
                'NC' => __('Newcomers', '12-step-meeting-list'),
                'FF' => __('No Fragrances', '12-step-meeting-list'),
                'O' => __('Open', '12-step-meeting-list'),
                'POC' => __('People of Color', '12-step-meeting-list'),
                'PRI' => __('Prison', '12-step-meeting-list'),
                'SCRE' => __('Screened', '12-step-meeting-list'),
                'A' => __('Secular', '12-step-meeting-list'),
                'SEN' => __('Seniors', '12-step-meeting-list'),
                'SWKR' => __('Sex Workers', '12-step-meeting-list'),
                'SP' => __('Speaker', '12-step-meeting-list'),
                'SPEC' => __('Special Interest', '12-step-meeting-list'),
                'SPON' => __('Sponsorship Focus', '12-step-meeting-list'),
                'ST' => __('Step Study', '12-step-meeting-list'),
                'S123' => __('Steps 1, 2, and 3', '12-step-meeting-list'),
                'D' => __('Topic Discussion', '12-step-meeting-list'),
                'TOPL' => __('Top Lines', '12-step-meeting-list'),
                'TR' => __('Tradition Study', '12-step-meeting-list'),
                'TRMA' => __('Trauma Focus', '12-step-meeting-list'),
                'VFOR' => __('Varied Format', '12-step-meeting-list'),
                'WDRL' => __('Withdrawal', '12-step-meeting-list'),
                'W' => __('Women', '12-step-meeting-list'),
                'Y' => __('Young People', '12-step-meeting-list'),
            ],
        ],
