...
= 3.19.19 =
* Declare `variables.php` globals so WP-CLI and cron imports don't fatal on PHP 8+ [more info](https://github.com/code4recovery/12-step-meeting-list/pull/2013)
...
= 3.19.2 =
* Fix shortcode issue [more info](https://github.com/code4recovery/12-step-meeting-list/issues/1776)
...
* Fix distance filters not persisting after reload [more info](https://github.com/code4recovery/12-step-meeting-list/issues/1753)
...
* Add Homegroup Online [more info](https://github.com/code4recovery/spec/pull/111)
